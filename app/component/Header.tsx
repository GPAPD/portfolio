      ...
      <nav aria-label="Global" className="mx-auto flex bg-gray-900 items-center justify-between p-6 lg:px-8 fixed top-0 left-0 w-full shadow-md z-50 ">
        <div className="flex lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5">
            <p className="text-2xl lg:text-4xl font-bold text-white">GPAPD</p>
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          ...
          <a href="#Home" className="text-sm/6 md:text-base/7 font-semibold text-white">
            Home
          </a>
          <a href="#About" className="text-sm/6 md:text-base/7 font-semibold text-white">
            About
          </a>
          <a href="#Experience" className="text-sm/6 md:text-base/7 font-semibold text-white">
            Experience
          </a>
        </PopoverGroup>
      </nav>
